package {
	...
	public class Text2NoSound extends Sprite { 
		...
		public function Text2NoSound(word_input:String,parent_input:Object){		
			...
			parent_obj.addChild(text_field);
			parent_obj.addChild(movie);
		...
		public function act(e:Event):void{
			if(j < 26){
				parent_obj.removeChild(text_field);
				parent_obj.removeChild(movie);
